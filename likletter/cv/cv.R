...
loc       <- "C:/Users/David.solano/OneDrive - Ipsos/David/Trabjo de Grado Maestria/CODIGOS/Trabajo de Grado - Codigos/Validacion Cruzada/"
model     <- "LSSP"
dataset   <- "synthetic"
prefix    <- paste0(model,"_",dataset)
path_outs <- "C:/Users/David.solano/OneDrive - Ipsos/David/Trabjo de Grado Maestria/CODIGOS/Trabajo de Grado - Codigos/Synthetic1/"
seed      <- 1     
...
base::source(paste0(loc, "dist_parallel.R"))
...
cv_parallel(Y, X, K_range, m, p, n, n_burn, n_sams, n_skip, model, dataset, loc, path_outs)
...
for(l in 1:5){
  ...
  cv = read_(paste0(path_outs, "_K_", K, "_l_", l, "_", dataset, "_", "cv.RData"))
...
for(l in 1:5){
  ...
  load(paste0(path_outs, "_K_", 2, "_l_", l, "_", dataset, "_", "cv.RData"))
